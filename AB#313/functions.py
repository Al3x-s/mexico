...
def check_location(wanted_room, adjacent_rooms):
    if wanted_room.isnumeric():
        ...
        return False
def check_item(item, current_room_items):
    if 
...
class Player:
    ...
    def add_to_inventory(self, item): # AAB#313--AB#313AB#313AB#313AB#313AB#313AB#313AB#313AB#313AB#313AB#313AB#313AB#313B#313
    def move(self, room):
